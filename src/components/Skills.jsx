...
export default function Skills() {
  ...
  return (
    <section id='skills' className='relative min-h-screen  flex flex-col items-center justify-center text-white px-4 py-10 mt-10 '>
        ...
        <img src={imghero} alt="left picture" className='absolute z-10 left-2 top-10 sm:left-16 sm:top-10 transform -rotate-12 w-24 h-auto sm:w-38 opacity-80'/>
        ...
        <img src={imghero} alt="Right picture" className='absolute z-10 right-2 top-10 sm:right-16 sm:top-10 transform rotate-12 w-24 h-auto sm:w-38 opacity-80' />
